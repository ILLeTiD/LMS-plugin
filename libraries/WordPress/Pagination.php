...
class Pagination
{
    ...
    public function __construct($current_page, $total_items, $per_page, $infinite_scroll = false)
    {
        $current_page = $current_page > $total_items ? $total_items : $current_page;
        $this->current_page = max(1, $current_page);

        $this->total_items = $total_items;
        $this->total_pages = ceil($total_items / $per_page);
        $this->per_page = $per_page;
        $this->infinite_scroll = $infinite_scroll;
    }

    public function display($which = 'top')
    {
