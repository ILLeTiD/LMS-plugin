    ...
    <div class="lms-slide-controls">
        <button class="lms-slide-control-fullscreen-option">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80">
                ...
                <title>Optons</title>
                <g id="Home">
                    <circle class="cls-1" cx="40" cy="40" r="3.5"/>
                    <circle class="cls-1" cx="23.5" cy="40" r="3.5"/>
                    <circle class="cls-1" cx="56.5" cy="40" r="3.5"/>
                </g>
            </svg>
        </button>
        <button class="lms-slide-control-fullscreen lms-slide-fullscreen">
            ...
            <svg xmlns="http://www.w3.org/2000/svg"
                 class="lms-slide-control-fullscreen-out"
                 viewBox="0 0 80 80">
                <defs>
                    <style>
                        .cls-1, .cls-2 {
            ...
            <div class="lms-nav-button lms-nav-button--check">
                <a href="#" class="" rel="next">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 80">
                        ...
                        <g id="Arrow-right">
                            <polyline class="cls-1" points="28 40.96 35.52 49.23 52 31.11"/>
                        </g>
                    </svg>
                </a>
            </div>
