<div class="course-controls">
    ...
    <div class="slide-controls">
        <button class="slide-control-fullscreen-option">
            ...
            <!--                 alt"back"="">  -->
            <img src="<?php echo plugin_dir_url(__FILE__) ?>../../assets/icons/PNG/Optons.png"
                 alt="back">
            </a>
        </button>
        <button class="slide-control-fullscreen slide-fullscreen">
            ...
            <img class="slide-control-fullscreen-in"
                 src="<?php echo plugin_dir_url(__FILE__) ?>../../assets/icons/PNG/Maximize.png"
                 alt="Go fullscreen">
            <img class="slide-control-fullscreen-out"
                 src="<?php echo plugin_dir_url(__FILE__) ?>../../assets/icons/PNG/Minimize.png"
                 alt="Go out fullscreen">
        </button>
        ...
        <div class="slide-control-navigation">
            <div class="nav-button">
                <a href="#" class="prev" rel="prev">
                    ...
                    <!--                    <img src="-->
                    <?php //echo base_plugin_dir_url() ?><!--/assets/icons/PNG/Arrow-left.png"-->
                    <!--                         alt="back"> -->
                    <img src="<?php echo plugin_dir_url(__FILE__) ?>../../assets/icons/PNG/Arrow-left.png"
                         alt="back">
                </a>
            </div>
            <div class="nav-button">
                <a href="#" class="next" rel="next">
                    <!--                    <img src="-->
                    <?php //echo base_plugin_dir_url() ?><!--/assets/icons/PNG/Arrow-right.png"-->
                    <!--                         alt="forward"> -->
                    <img src="<?php echo plugin_dir_url(__FILE__) ?>../../assets/icons/PNG/Arrow-right.png"
                         alt="forward">
                </a>
            </div>
        </div>
